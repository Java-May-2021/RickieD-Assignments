public class Wizard extends Human {
    ...
    public void heal(Human healed) {
        ...
        System.out.println("(I've been HEALED!) Health level increased to: " + healed.healthLvl);
    }
    ...
    public void fireball(Human attacked) {
        ...
        System.out.println("(I've been attacked! The humanity!) Health level decreased to: " + attacked.healthLvl);
