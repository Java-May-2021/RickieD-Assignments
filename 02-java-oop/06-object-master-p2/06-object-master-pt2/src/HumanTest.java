public class HumanTest {
    public static void main(String[] args) {
        ...
        // System.out.println("\n--------Human current health level: " + h.healthLvl + "----------");
        // System.out.println("\n--------Wizard current health level: " + w.healthLvl + "----------");
        // System.out.println("\n--------Ninja current health level: " + n.healthLvl + "----------");
        // System.out.println("\n--------Samurai current health level: " + s.healthLvl + "----------");
        // System.out.println("\n--------Samurai2 current health level: " + s2.healthLvl + "----------");


        System.out.println("\n--------Battle between Wizard and Ninja!----------");
        ...
        System.out.println("\n--------Battle between Samurai and Human!----------");
        ...
        System.out.println("\n--------Battle between Samurai and Samurai2!----------");
        ...
        System.out.println("\n--------Battle between Samurai3 and Ninja!----------");
